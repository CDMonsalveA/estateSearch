...
if __name__ == "__main__":
    # Example usage
    rightmove = Rightmove(SearchParams=SearchParams(location="Maidstone, Kent", max_bedrooms=2, min_bedrooms=2, min_price=90000, max_price=90000))
    properties = rightmove.get_properties_details()
    print(f"Found {len(properties)} properties, total information storage usage: {sys.getsizeof(properties)} bytes")
